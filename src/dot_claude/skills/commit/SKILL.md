---
name: commit
description: This skill should be used when the user asks to commit, or uses /commit
---
...
3. Write a conventional commit message:
    ...
    - Add a body (separated by blank line) only if the description alone is insufficient to understand the change. Use `*` bullets to outline the summary.
